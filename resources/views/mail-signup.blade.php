        ...
        <div class="p-8">
            <div class="mt-8 mx-auto max-w-lg">
                ...
                <label class="mb-8 block">
                    ...
                    <div class="flex">
                        <input class="px-3 py-2 text-xl max-w-xs flex-1 shadow rounded-l-lg leading-normal" v-model="mail" type="text" placeholder="Enter your email" @keyup.enter="subscribe">
