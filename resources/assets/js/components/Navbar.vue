    ...
    <nav v-if="$route.path != '/'" class="hidden md:flex bg-blue text-white flex-col border-r border-blue-lighter select-none flex-no-shrink">
       ...
       <div class="py-8 pl-6 flex-1 flex flex-col">
           ...
           <ul class="list-reset mb-8">
                ...
                <li class="mb-2">
                    <a href="/logout" class="flex text-white no-underline hover:bg-blue-dark py-2 block pl-2 pr-8 rounded-lg rounded-r-none">
           ...
           <ul class="list-reset">
                ...
                <li class="mb-2">
                    <a href="mailto:hello.whalecore@gmail.com" class="flex text-white no-underline hover:bg-blue-dark py-2 block pl-2 pr-8 rounded-lg rounded-r-none">
